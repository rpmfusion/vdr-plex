...
%changelog
* Sun Aug 02 2026 RPM Fusion Release Engineering <leigh123linux@rpmfusion.org> - 0.4.0-55
...
* Mon Mar 23 2026 Martin Gansser <martinkg@fedoraproject.org> - 0.4.0-52
- Rebuilt for new VDR 2.8.1 API version 12

* Mon Feb 09 2026 Martin Gansser <martinkg@fedoraproject.org> - 0.4.0-51
- Rebuilt for new VDR API version 2.7.9

* Tue Feb 03 2026 Martin Gansser <martinkg@fedoraproject.org> - 0.4.0-50
- Rebuilt for new VDR API version 2.7.8

* Mon Feb 02 2026 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 0.4.0-49
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Aug 01 2025 Martin Gansser <martinkg@fedoraproject.org> - 0.4.0-48
- Rebuilt for new VDR API version 2.7.7

* Sun Jul 27 2025 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 0.4.0-47
